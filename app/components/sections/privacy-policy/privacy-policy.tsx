			...
			<div className="px-4 sm:px-50 flex flex-col">
				<div className="font-sans p-6 text-xl flex flex-col gap-4 leading-10 text-justify">
					...
					<p>
						...
						conference in Indonesia organized by the <b>Python ID Community</b>.
					</p>
					<p>
					...
					<p>
						...
						information across our official event website and related services.
					</p>
				</div>
				...
				<div className="font-sans p-6 text-xl flex flex-col gap-4 leading-10 text-justify">
					...
					<ul className="list-disc list-inside">
						...
						<li>
							Contact us for inquiries or engage with our communication channels
							(e.g., email or social media)
						</li>
					</ul>
					<p>
						This may include (but is not limited to): your name, email address,
						phone number, organization, job title, and other details relevant to
						your participation in PyCon ID 2026.
					</p>
				</div>
				<h1 className="font-display text-3xl font-extrabold text-justify">
				...
				<div className="font-sans p-6 text-xl flex flex-col gap-4 leading-10 text-justify">
					...
					<ul className="list-disc list-inside">
						...
						<li>
							Communicate important event updates, schedules, and announcements
						</li>
						<li>
							Handle ticketing and payments through our secure payment partners
						</li>
						<li>Respond to your inquiries or requests for support</li>
						<li>Prepare event reports and statistics</li>
						<li>
							Facilitate optional networking or sponsor engagement (opt-in only)
						</li>
						<li>
				...
				<div className="font-sans p-6 text-xl flex flex-col gap-4 leading-10 text-justify">
					...
					<p>
						While we strive to ensure the highest security, please note that no
