			...
			<div className="px-4 sm:px-50 flex flex-col">
				<div className="font-sans p-6 text-xl flex flex-col gap-4 leading-10 text-justify">
					<p>
						...
						attending PyCon ID 2026, you agree with the Code of Conduct.
					</p>
				</div>
				...
				<div className="font-sans p-6 text-xl flex flex-col gap-4 leading-10 text-justify">
					...
					<p>
						Be careful in the words that you choose. Remember that
						sexist,racist, and other exclusionary jokes can be offensive to
						those around you. Excessive swearing and offensive jokes are not
				...
				<div className="font-sans p-6 text-xl flex flex-col gap-4 leading-10 text-justify">
					...
					<p>
						...
						violation by directly approaching one of our staff in the venue.
					</p>
					<p>
						We expect participants to respect each others and help us to keep
						the conference safe for everyone.
					</p>
				</div>
				<h1 className="text-3xl font-extrabold text-justify">License</h1>
				<div className="font-sans p-6 text-xl flex flex-col gap-4 leading-10 text-justify">
					<p>
