			...
			<div className="relative">
				<div className="flex items-center gap-4 px-6 lg:px-12 pt-6 absolute top-20 left-0 right-0 z-20">
					<NavLink
						...
						className={({ isActive }) =>
							`flex items-center gap-3 pl-[11px] pr-4 w-[168px] h-8 text-sm font-bold transition-colors ${
								isActive
									? "bg-[#FAFAFA] text-[#282828]"
									: "border border-white text-[#F1F2F3] hover:text-white"
							}`
						}
						style={{
