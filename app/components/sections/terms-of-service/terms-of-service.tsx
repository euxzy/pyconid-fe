		...
		<div className="z-10 relative container m-auto">
			...
			<div className="px-4 sm:px-50 flex flex-col">
				<div className="font-sans p-6 text-xl flex flex-col gap-4 leading-10 text-justify">
					...
					<p>
						If you do not agree to these Terms, please do not register or attend
						the event.
					</p>
				</div>
				...
				<div className="font-sans p-6 text-xl flex flex-col gap-4 leading-10 text-justify">
					<ul className="list-disc list-inside">
						...
						<li>
							...
							the discretion of the organizers under exceptional circumstances.
						</li>
						<li>
							Tickets are <b>non-transferable</b> without prior written approval
							from the organizers.
						</li>
						<li>
							...
							<ul className="list-disc list-inside pl-10">
								<li>
									Has been banned from the Python ID Community or its events, or
								</li>
								<li>
				...
				<h1 className="text-3xl font-extrabold text-justify">Event Conduct</h1>
				<div className="font-sans p-6 text-xl flex flex-col gap-4 leading-10 text-justify">
					<p>
						All attendees, speakers, sponsors, and volunteers must adhere to the{" "}
						<b>PyCon Indonesia Code of Conduct</b>, which promotes a safe,
				...
				<div className="font-sans p-6 text-xl flex flex-col gap-4 leading-10 text-justify">
					<ul className="list-disc list-inside">
						<li>
							The event may be <b>recorded, photographed, and live-streamed</b>{" "}
							for documentation, educational, and promotional purposes.
						</li>
						<li>
							By attending PyCon Indonesia 2026, you consent to the use of your{" "}
							<b>image, likeness, and voice</b> in event documentation,
							photography, or video recordings that may be published on official
							Python ID or PyCon Indonesia channels (e.g., YouTube, social
							media, or website).
						</li>
						<li>
							If you prefer not to appear in published materials, please notify
							the organizers in advance, and we will make reasonable efforts to
							accommodate your request.
						</li>
						<li>
							Presenters retain ownership of their own content and presentation
							materials but grant PyCon Indonesia permission to record and share
							their sessions publicly.
						</li>
						<li>
							Unauthorized recording or redistribution of event sessions or
							materials by participants is not permitted without prior approval
							from the organizers.
						</li>
					</ul>
				</div>
				...
				<div className="font-sans p-6 text-xl flex flex-col gap-4 leading-10 text-justify">
					<ul className="list-disc list-inside">
						...
						<li>
							Please follow all safety instructions provided by event staff and
							venue management.
						</li>
					</ul>
				</div>
				...
				<div className="font-sans p-6 text-xl flex flex-col gap-4 leading-10 text-justify">
					<ul className="list-disc list-inside">
						<li>
							...
							<b>modify, reschedule, or cancel</b> PyCon Indonesia 2026 in whole
							or in part due to unforeseen circumstances, including but not
							limited to natural disasters, health emergencies, or venue issues.
						</li>
						<li>
							In such cases, we will make reasonable efforts to notify attendees
							promptly and, where possible, provide alternative arrangements or
							compensation options.
						</li>
						<li>
							The organizers are not responsible for any external costs incurred
							(such as travel or accommodation) resulting from event changes or
							cancellation.
						</li>
					</ul>
				</div>
				...
				<div className="font-sans p-6 text-xl flex flex-col gap-4 leading-10 text-justify">
					<ul className="list-disc list-inside">
						...
						<li>
							...
							property of their respective authors or the organizing committee.
						</li>
					</ul>
				</div>
				<h1 className="text-3xl font-extrabold text-justify">
				...
				<div className="font-sans p-6 text-xl flex flex-col gap-4 leading-10 text-justify">
					<p>
						...
						operations or applicable laws. The most current version will always
						be available on our official website, and continued participation in
						PyCon Indonesia constitutes acceptance of any updated Terms.
					</p>
				</div>
				<h1 className="text-3xl font-extrabold text-justify">Governing Law</h1>
				<div className="font-sans p-6 text-xl flex flex-col gap-4 leading-10 text-justify">
					<p>
				...
				<h1 className="text-3xl font-extrabold text-justify">Contact Us</h1>
				<div className="font-sans p-6 text-xl flex flex-col gap-4 leading-10 text-justify">
					<p>
